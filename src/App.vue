          ...
          >
            <div :class="['flex items-center gap-3 p-3 rounded-lg', darkMode ? 'bg-gray-700' : 'bg-gray-50']">
              ...
              <div v-if="sidebarOpen || isMobile" class="flex-1 min-w-0">
                <p :class="['text-sm font-semibold truncate', darkMode ? 'text-white' : 'text-gray-900']">
                  {{ user.name }}
                </p>
              ...
              <button 
                ...
                :class="[
                  ...
                  darkMode ? 'hover:bg-gray-600 text-gray-400 hover:text-red-400' : 'hover:bg-gray-200 text-gray-600 hover:text-red-500'
                ]"
                title="Logout"
              >
...
const user = computed(() => authStore.user || store.user)
